...
import {ACCENT_BLUE, ACCENT_MAP, ACCENT_PURPLE, ACCENT_RED, ACCENT_RAINBOW, ACCENT_HATCH, Theme} from '../../lib/themes/index.js';
...
const options = defineMessages({
    [ACCENT_HATCH]: {
        defaultMessage: 'Hatch.lol',
        description: 'Name of the Hatch.lol color scheme, used by the Hatch.lol editor by default.',
        id: 'tw.accent.hatch'
    },
    [ACCENT_RED]: {
        defaultMessage: 'Red',
        description: 'Name of the red color scheme.',
        id: 'tw.accent.red'
    },
    [ACCENT_PURPLE]: {
